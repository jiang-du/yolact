...
def parse_args(argv=None):
    ...
    parser.add_argument('--display_masks', default=False, type=str2bool, # 检测人不需要mask
    ...
    # parser.add_argument('--image', default="test.jpg", type=str, # 监控图像测试
    ...
    parser.add_argument('--video', default="20190921_20190921185811_20190921211639_184942.mp4_20190925_234507.mp4", type=str, # 监控视频测试
                        help='A path to a video to evaluate on. Passing in a number will use that index webcam.')
    parser.add_argument('--video_multiframe', default=1, type=int,
                        help='The number of frames to evaluate in parallel to make videos play at higher fps.')
    parser.add_argument('--score_threshold', default=0.2, type=float, # 这个还没想好设多少
